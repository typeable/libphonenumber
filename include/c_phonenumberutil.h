...
void c_phone_number_util_get_national_significant_number(PhoneNumber const *, c_string *);
void c_phone_number_util_get_country_mobile_token(int, c_string *);
void c_phone_number_util_format(PhoneNumber const *, enum phone_number_format, c_string *);
void c_phone_number_util_format_national_number_with_carrier_code(PhoneNumber const *, char const *, size_t, c_string *);
void c_phone_number_util_format_national_number_with_preferred_carrier_code(PhoneNumber const *, char const *, size_t, c_string *);
void c_phone_number_util_format_number_for_mobile_dialing(PhoneNumber const *, char const *, size_t, int, c_string *);
void c_phone_number_util_format_out_of_country_calling_number(PhoneNumber const *, char const *, size_t, c_string *);
void c_phone_number_util_format_in_original_format(PhoneNumber const *, char const *, size_t, c_string *);
void c_phone_number_util_format_out_of_country_keeping_alpha_chars(PhoneNumber const *, char const *, size_t, c_string *);
// /!\ May return NULL
PhoneNumber *c_phone_number_util_truncate_too_long_number(PhoneNumber const *);
enum phone_number_type c_phone_number_util_get_number_type(PhoneNumber const *);
int c_phone_number_util_is_valid_number(PhoneNumber const *);
int c_phone_number_util_is_valid_number_for_region(PhoneNumber const *, char const *, size_t);
void c_phone_number_util_get_region_code_for_number(PhoneNumber const *, c_string *);
...
enum validation_result c_phone_number_util_is_possible_number_for_type_with_reason(PhoneNumber const *, enum phone_number_type);
int c_phone_number_util_can_be_internationally_dialed(PhoneNumber const *);
int c_phone_number_util_is_number_geographical_1(PhoneNumber const *);
int c_phone_number_util_is_number_geographical_2(enum phone_number_type, int);
enum error_type c_phone_number_util_parse(char const *, size_t, char const *, size_t, PhoneNumber **);
enum error_type c_phone_number_util_parse_and_keep_raw_input(char const *, size_t, char const *, size_t, PhoneNumber **);
enum match_type c_phone_number_util_is_number_match(PhoneNumber const *, PhoneNumber const *);
enum match_type c_phone_number_util_is_number_match_with_two_strings(char const *, size_t, char const *, size_t);
enum match_type c_phone_number_util_is_number_match_with_one_string(PhoneNumber const *, char const *, size_t);
